...
# Package       : birthday3         
# Version       : 1.4.5         
# Source repo   : http://bith/birthday.com         
# Language	  : Python         
# Tested on     : ubi_8.5         
# Travis-Check  : True         
# Script License: Apache License Version 2.0          
# Maintainer    : saurabh_gore.com         
...
# ---------------------------------------------------------------------------- 
PACKAGE_NAME=babel-plugin-dev-expression
PACKAGE_VERSION=0.2.2
PACKAGE_URL=https://github.com/4Catalyzer/babel-plugin-dev-expression
